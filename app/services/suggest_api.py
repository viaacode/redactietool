...
class SuggestApi:
    ...
    def __init__(self):
        self.SPARQL_ENDPOINT = os.environ.get("SPARQL_ENDPOINT", "http://sparql_test_endpoint")
        self.USER = os.environ.get("SPARQL_USER", "test")
        self.PASSWORD = os.environ.get("SPARQL_PASS", "test")
        self.TOKEN = os.environ.get("SPARQL_TOKEN", "test")
